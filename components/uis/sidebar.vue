...
<template>
    <aside :class="`fixed h-screen z-50 top-0 left-0 w-full xxs:w-4/5 xs:w-3/5 md:w-64 transition-transform ease-linear md:transition-none duration-500 -translate-x-full md:translate-x-0 ${sidebarStatus ? 'translate-x-0' : ''}`">
